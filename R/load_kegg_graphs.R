...
#' @description This function will download all kegg KGML files assigned by \code{spec}.
#' @param spec, a character, refers to the species names in kegg, such as "hsa","mmu"...
